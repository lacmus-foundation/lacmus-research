...
mkdir /artefacts/combined_model
cp logs/combined_model_e1/* /artefacts/combined_model/
cp snapshots/resnet50_pascal_01.h5 /artefacts/combined_model/combined_model_e1.h5  
